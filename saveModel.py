...
imageRoot = "../DataSets/WarmthOfImage/cropped/"
...
for cls in classesDir:
    ...
    for imageName in classList:
        ...
        if(counter == batch_size_for_models):
            ...
            saveModel("../DataSets/WarmthOfImage/models/cropped/train_data"+ str(fc) +".npy", np.array(train_data))
            saveModel("../DataSets/WarmthOfImage/models/cropped/train_label"+ str(fc) +".npy", np.array(train_label))
...
#rest of images which stays in lists , add their models lastly
if(len(train_data)!=0):
    train_data,train_label = shuffle(train_data,train_label)
    saveModel("../DataSets/WarmthOfImage/models/cropped/train_data.npy", np.array(train_data))
    saveModel("../DataSets/WarmthOfImage/models/cropped/train_label.npy", np.array(train_label))
